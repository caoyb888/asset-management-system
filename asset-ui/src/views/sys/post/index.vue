  ...
  <div class="page-container">
    ...
    <div class="page-header">
      <div class="page-header-left">
        ...
        <p class="page-desc">管理系统岗位配置，用于用户岗位分配</p>
      </div>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="480px" destroy-on-close>
      <el-form ref="formRef" :model="form" :rules="formRules" label-width="90px">
        <el-form-item label="岗位编码" prop="postCode">
          <el-input v-model="form.postCode" :disabled="!!form.id" placeholder="请输入岗位编码（唯一）" />
        </el-form-item>
...
const form = reactive<PostCreateDTO & { id?: number }>({
  postCode: '', postName: '', sortOrder: 0, status: 1,
})
const formRef = ref()
const formRules = {
...
async function doDelete(id: number) {
  await ElMessageBox.confirm('确认删除该岗位？有用户关联时不允许删除。', '警告', { type: 'warning' })
