...
(93001, 93001, 91001, '固定租金',   15000.00, '2026年1月租金',   0, 'admin', 'admin'),
(93002, 93001, 91002, '物业管理费',  3000.00, '2026年1月物业费',  0, 'admin', 'admin'),
-- 93002 收款单的拆分：租金8000（部分）
(93003, 93002, 91001, '固定租金',    8000.00, '2026年2月租金预收', 0, 'admin', 'admin'),
-- 93003 收款单的拆分：租金15000+物业3000+多余2000
(93004, 93003, 91001, '固定租金',   15000.00, '2026年3月租金',   0, 'admin', 'admin'),
(93005, 93003, 91002, '物业管理费',  3000.00, '2026年3月物业费',  0, 'admin', 'admin'),
(93006, 93003, 91001, '预收押金',    2000.00, '超额预存',        0, 'admin', 'admin'),
-- 93004 未名款（单笔，无费项）
(93007, 93004, NULL,  '待认领款项',  5000.00, '来源不明，待认领',  0, 'admin', 'admin')
...
(93001, 93001, 93001, 91001, '2026-01', 15000.00, 0.00, 0, 'admin', 'admin'),
(93002, 93001, 93005, 91002, '2026-01',  3000.00, 0.00, 0, 'admin', 'admin'),
-- 核销单 93002 → 应收 93002 租金8000（部分）
(93003, 93002, 93002, 91001, '2026-02',  8000.00, 0.00, 0, 'admin', 'admin'),
-- 核销单 93003（驳回）→ 应收 93003（驳回后未生效）
(93004, 93003, 93003, 91001, '2026-03', 15000.00, 0.00, 0, 'admin', 'admin')
...
VALUES
-- 凭证 93001 分录（已上传）
(93001, 93001, 1, 93001, '1002', '银行存款',  18000.00,     0.00, '收到2026年1月租金及物业费', 0, 'admin', 'admin'),
(93002, 93001, 1, 93001, '1122', '应收账款',      0.00, 18000.00, '核销2026年1月应收账款',   0, 'admin', 'admin'),

-- 凭证 93002 分录（已审核）
(93003, 93002, 1, 93002, '1002', '银行存款',   8000.00,     0.00, '收到2026年2月租金（部分）', 0, 'admin', 'admin'),
(93004, 93002, 1, 93002, '1122', '应收账款',      0.00,  8000.00, '核销2026年2月部分应收',   0, 'admin', 'admin'),

-- 凭证 93003 分录（草稿）
(93005, 93003, 1, 93003, '1002', '银行存款',  20000.00,     0.00, '收到2026年3月款项',      0, 'admin', 'admin'),
(93006, 93003, 1, 93003, '1122', '应收账款',      0.00, 20000.00, '核销2026年3月应收账款',   0, 'admin', 'admin')
